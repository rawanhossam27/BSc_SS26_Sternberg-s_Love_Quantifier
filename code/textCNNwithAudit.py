...
raw_csv_path = output_dir / "textcnn_raw_outputs.csv"
raw_df.to_csv(raw_csv_path, index=False)

print("\nRaw TextCNN outputs saved to:", raw_csv_path)
schema_markers = {
    "intimacy": [
...
raw_with_evidence_path = output_dir / "textcnn_raw_outputs_with_evidence.csv"
...
raw_with_scores_path = output_dir / "textcnn_raw_outputs_with_evidence_scores.csv"
...
# Save file
verified_path = output_dir / "textcnn_verified_outputs.csv"
...
comparison_df = pd.DataFrame({
    "version": ["Raw TextCNN", "TextCNN + Audit"],
